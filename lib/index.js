...
var JNetworkGroup = /** @class */ (function () {
    ...
    JNetworkGroup.prototype.fetchRequest = function (method, baseUrl, url, parameters, headers, otherObject) {
        ...
        extraParas.forEach(function (key) {
            ...
            if (!delegate)
                return;
            globalOtherParas = __assign({}, globalOtherParas, jgetGlobalValue(key, delegate.globalParas));
        });
        ...
        extraHeaders.forEach(function (key) {
            ...
            if (!delegate)
                return;
            globalOtherHeaders = __assign({}, globalOtherParas, jgetGlobalValue(key, delegate.globalHeaders));
        });
...
var JNetworkWorker = /** @class */ (function (_super) {
    ...
    function JNetworkWorker(config) {
        var _this = this;
        config = __assign({}, JNetworkConfig.config, config);
    ...
    JNetworkWorker.prototype.POST_DATA = function (url, paras, headers, otherObject) {
        return this._prefixPromise('POST', url, paras, headers, otherObject);
    };
    JNetworkWorker.prototype.GET_DATA = function (url, paras, headers, otherObject) {
        return this._prefixPromise('GET', url, paras, headers, otherObject);
    };
    JNetworkWorker.prototype.POST = function (url, paras, headers, otherObject) {
        throw new Error("JNetworkWorker's POST method is deprecated, please use POST_DATA method");
    };
    JNetworkWorker.prototype.GET = function (url, paras, headers, otherObject) {
        throw new Error("JNetworkWorker's GET method is deprecated, please use GET_DATA method");
    };
    JNetworkWorker.prototype._prefixPromise = function (method, url, paras, headers, otherObject) {
        var _this = this;
        var doIt = null;
        if (method === 'GET') {
            doIt = _super.prototype.GET.call(this, url, paras, headers, otherObject);
        }
        if (method === 'POST') {
            doIt = _super.prototype.POST.call(this, url, paras, headers, otherObject);
        }
        var isOk, _response;
        return doIt.then(function (response) {
            isOk = response.status === 200;
            _response = response;
            if (!isOk) {
                console.log('失败');
    ...
    JNetworkWorker.prototype.prefixPromise = function (url, paras, headers, otherObject) {
        try {
            return this._prefixPromise('POST', url, paras, headers, otherObject);
        }
        catch (e) {
...
var JNetworkAccount = /** @class */ (function (_super) {
    ...
    JNetworkAccount._instance = function () {
        if (!_instance) {
...
var JNetworkCinema = /** @class */ (function (_super) {
    ...
    JNetworkCinema._instance = function () {
        if (!_instance$1) {
            _instance$1 = new JNetworkCinema();
        }
        return _instance$1;
    };
...
var JNetworkCity = /** @class */ (function (_super) {
    ...
    JNetworkCity._instance = function () {
        if (!_instance$2) {
            _instance$2 = new JNetworkCity();
        }
        return _instance$2;
    };
...
var JNetworkFilm = /** @class */ (function (_super) {
    ...
    JNetworkFilm._instance = function () {
        if (!_instance$3) {
            _instance$3 = new JNetworkFilm();
        }
        return _instance$3;
    };
...
var JNetworkMine = /** @class */ (function (_super) {
    ...
    JNetworkMine._instance = function () {
        if (!_instance$4) {
            _instance$4 = new JNetworkMine();
        }
        return _instance$4;
    };
...
var JNetworkOther = /** @class */ (function (_super) {
    ...
    JNetworkOther._instance = function () {
        if (!_instance$5) {
            _instance$5 = new JNetworkOther();
        }
        return _instance$5;
    };
...
var JNetworkTrade = /** @class */ (function (_super) {
    ...
    JNetworkTrade._instance = function () {
        if (!_instance$6) {
            _instance$6 = new JNetworkTrade();
        }
        return _instance$6;
    };
