...
function _cinemaScreeningItems(data) {
    ...
    for (var i = 0; i < data.showItems.length; i++) {
...
var TradeManager = /** @class */ (function () {
     ...
     */
    TradeManager.prototype.lockSeat = function (tradeParas, seatList, mobile, b, openId, cinemaId, cityId) {
        if (tradeParas.type === 'meituan' || tradeParas.type === 'dazhong') {
            tradeParas.type = 'maoyan';
        }
        var paras = __assign({}, tradeParas, { mobile: mobile }, this.seatInforParas(tradeParas.type, seatList), { b: b, openId: openId, cinemaId: cinemaId, cityId: cityId });
        console.log(paras);
        console.log(JNetworkTrade$2);
