...
var SeatManager = /** @class */ (function () {
    ...
    SeatManager.formatSeatParams = function (params) {
        var showId;
        switch (params.type) {
            case 'meituan':
...
var TradeManager = /** @class */ (function () {
     ...
     * @returns {*} 商务参数
     */
    TradeManager.tradeParasFromPlatform = function (platform, jbzFilmId, jbzCinemaId) {
        console.log(platform);
        console.log('----------');
        var type = platform.type, hasDiscount = platform.hasDiscount;
        var showId = SeatManager.formatSeatParams(platform).showId;
        // 这里标注下：配合后端所以只能这么写
        return { type: type, imax: window.sessionStorage.imax === 'true' ? 1 : 0, showId: showId, isLoweastForetell: hasDiscount, jbzCinemaId: jbzCinemaId, jbzFilmId: jbzFilmId, filmId: jbzFilmId };
    };
    /**
     * 获取锁座时需要的座位参数
     * @param type 平台类型
