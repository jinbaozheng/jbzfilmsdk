...
var TradeManager = /** @class */ (function () {
     ...
     */
    TradeManager.prototype.lockSeat = function (tradeParas) {
        if (tradeParas.type === 'meituan' || tradeParas.type === 'dazhong') {
            tradeParas.type = 'maoyan';
        }
        var paras = __assign({}, tradeParas, this.seatInforParas(tradeParas.type, tradeParas.selectedSeats));
        console.log(paras);
        return paras;
    };
    return TradeManager;
